...
import { addCustomSmartView, loadCustomSmartViews } from '@/utils/customSmartViews';
...
export const SaveSmartViewSheet = ({
  ...
  const handleSave = async () => {
    ...
    // Free plan capacity gate (2 custom smart views)
    const existing = await loadCustomSmartViews();
    if (!requireCapacity('smartListsCustom', existing.length)) return;
