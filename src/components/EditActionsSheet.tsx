...
export const getDefaultActions = (t: (key: string) => string): ActionItem[] => [
  { id: 'date', name: t('editActions.date'), icon: CalendarIcon, enabled: true, color: 'text-primary', group: 'scheduling' },
  { id: 'deadline', name: t('editActions.deadline'), icon: CalendarClock, enabled: true, color: 'text-destructive', group: 'scheduling' },
  { id: 'reminder', name: t('editActions.reminders'), icon: Timer, enabled: true, color: 'text-primary', group: 'scheduling' },
  { id: 'repeat', name: t('editActions.repeat'), icon: Repeat, enabled: true, color: 'text-primary', group: 'scheduling' },
  { id: 'urgent', name: t('editActions.urgent'), icon: AlertTriangle, enabled: true, color: 'text-destructive', group: 'scheduling' },
  { id: 'priority', name: t('editActions.priority'), icon: Flag, enabled: true, color: 'text-primary', group: 'organization' },
  { id: 'tags', name: t('editActions.tags'), icon: Tag, enabled: true, color: 'text-primary', group: 'organization' },
  { id: 'folder', name: t('editActions.folder'), icon: FolderIcon, enabled: true, color: 'text-primary', group: 'organization' },
  { id: 'section', name: t('editActions.section'), icon: ListTodo, enabled: true, color: 'text-primary', group: 'organization' },
  { id: 'description', name: t('editActions.description'), icon: FileText, enabled: true, color: 'text-primary', group: 'organization' },
  { id: 'image', name: t('editActions.image'), icon: ImageIcon, enabled: true, color: 'text-primary', group: 'media' },
  { id: 'attachment', name: t('editActions.files'), icon: Paperclip, enabled: true, color: 'text-primary', group: 'media' },
];

export const defaultActions: ActionItem[] = [
  { id: 'date', name: 'Date', icon: CalendarIcon, enabled: true, color: 'text-primary', group: 'scheduling' },
  { id: 'deadline', name: 'Deadline', icon: CalendarClock, enabled: true, color: 'text-destructive', group: 'scheduling' },
  { id: 'reminder', name: 'Reminders', icon: Timer, enabled: true, color: 'text-primary', group: 'scheduling' },
  { id: 'repeat', name: 'Repeat', icon: Repeat, enabled: true, color: 'text-primary', group: 'scheduling' },
  { id: 'urgent', name: 'Urgent', icon: AlertTriangle, enabled: true, color: 'text-destructive', group: 'scheduling' },
  { id: 'priority', name: 'Priority', icon: Flag, enabled: true, color: 'text-primary', group: 'organization' },
  { id: 'tags', name: 'Tags', icon: Tag, enabled: true, color: 'text-primary', group: 'organization' },
  { id: 'folder', name: 'Folder', icon: FolderIcon, enabled: true, color: 'text-primary', group: 'organization' },
  { id: 'section', name: 'Section', icon: ListTodo, enabled: true, color: 'text-primary', group: 'organization' },
  { id: 'description', name: 'Description', icon: FileText, enabled: true, color: 'text-primary', group: 'organization' },
  { id: 'image', name: 'Image', icon: ImageIcon, enabled: true, color: 'text-primary', group: 'media' },
  { id: 'attachment', name: 'Files', icon: Paperclip, enabled: true, color: 'text-primary', group: 'media' },
];
...
export const EditActionsSheet = ({ isOpen, onClose, actions, onSave }: EditActionsSheetProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-background flex flex-col animate-in slide-in-from-bottom duration-300" style={{ paddingTop: 'var(--safe-top, 0px)', paddingLeft: 'var(--safe-left, 0px)', paddingRight: 'var(--safe-right, 0px)', paddingBottom: 'var(--safe-bottom, 0px)', zIndex: isOnboarding ? 400 : 80 }}>
      {/* Header */}
