...
import landingTodoImg2 from '@/assets/landing-todo-2.webp';
import landingCalendarImg from '@/assets/landing-calendar.webp';
import landingPomodoroImg from '@/assets/landing-pomodoro.webp';
import landingHabitsImg from '@/assets/landing-habits.webp';
import landingHabitsImg2 from '@/assets/landing-habits-2.webp';
import landingHabitsIphone from '@/assets/landing-habits-iphone.webp';
import landingCountdownImg from '@/assets/landing-countdown.webp';
...
import includeNotesImg from '@/assets/flowist-include-notes.webp.asset.json';
import includeTasksImg from '@/assets/flowist-include-tasks.webp.asset.json';
import includeNotebooksImg from '@/assets/flowist-include-notebooks.webp.asset.json';
import includeHabitsImg from '@/assets/flowist-include-habits.webp.asset.json';
import includeMatrixImg from '@/assets/flowist-include-matrix.webp.asset.json';
import includeBasicBlocksImg from '@/assets/flowist-include-basic-blocks.webp.asset.json';
import includeMarkdownImg from '@/assets/flowist-include-markdown.webp.asset.json';
import includeSlashImg from '@/assets/flowist-include-slash.webp.asset.json';
import includeWebClipperImg from '@/assets/flowist-include-webclipper.webp.asset.json';
        ...
        <section id="about" className="relative overflow-hidden scroll-mt-20">
          ...
          <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-5 pt-10 pb-8 sm:px-6 sm:pt-20 sm:pb-16 md:grid-cols-2">
            <div className="text-center md:text-left">
              ...
              <h1 className="mb-5 text-[32px] font-bold leading-[1.15] tracking-tight text-slate-800 sm:text-[36px]">
                <span className="block whitespace-nowrap">Notes, tasks &amp; habits</span>
          ...
          <div className="mx-auto max-w-6xl px-5 sm:px-6">
            ...
            <div className="relative mx-auto hidden w-full max-w-xl md:block">
              ...
              <img
                ...
                loading="lazy"
                decoding="async"
                className="relative w-full drop-shadow-[0_40px_60px_rgba(30,60,140,0.35)]"
              />
            </div>
            ...
            <div className="relative mx-auto block w-full max-w-sm md:hidden">
              ...
              <img
                ...
                loading="lazy"
                decoding="async"
                className="relative w-full drop-shadow-[0_25px_40px_rgba(30,60,140,0.3)]"
              />
            </div>
