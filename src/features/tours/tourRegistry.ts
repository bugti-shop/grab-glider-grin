...
export const FEATURE_TOURS: FeatureTour[] = [
  ...
  hint('task-set-priority', 'tasks', 'Set a task priority', 'Open any task and tap the ⋮ menu to mark it High, Medium, Low or None.', '/todo/today', { beforeStart: 'event:flowist-tour-open-first-task', target: '[data-tour="task-detail-options"]', side: 'bottom' }),
