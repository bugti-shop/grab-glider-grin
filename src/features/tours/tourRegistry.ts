...
export const FEATURE_TOURS: FeatureTour[] = [
  ...
  hint('task-natural-language', 'tasks', 'Try natural language input', 'Type e.g. "Buy Groceries tomorrow at 6:46 PM" — Flowist auto-parses date & time.', '/todo/today', { beforeStart: '[data-tour="todo-add-task"]', target: '[data-tour="task-input-sheet-input"]', side: 'top' }),
  hint('task-scan-from-image', 'tasks', 'Scan tasks from notes or screenshots', 'Use the AI scanner to extract tasks from a photo or screenshot.', '/todo/today', { premium: true, beforeStart: '[data-tour="todo-add-task"]', target: '[data-tour="task-input-scan-button"]', side: 'top' }),
  ...
  hint('task-switch-view', 'tasks', 'Switch view — Timeline or Status', 'Open the ⋮ menu and switch between Flat, Status, Timeline, or Priority.', '/todo/today', { beforeStart: '[data-tour="todo-options-menu"]', target: '[data-tour="todo-menu-view-modes"]', side: 'top' }),
