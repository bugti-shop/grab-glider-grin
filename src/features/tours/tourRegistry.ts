...
export const FEATURE_TOURS: FeatureTour[] = [
  ...
  hint('task-natural-language', 'tasks', 'Try natural language input', 'Type e.g. "Buy Groceries tomorrow at 6:46 PM" — Flowist auto-parses date & time.', '/todo/today', { target: '[data-tour="todo-add-task"]' }),
